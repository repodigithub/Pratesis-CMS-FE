...
<q-page>
            ...
            <core-table
                ...
                <template v-slot:body-cell-status="props">
                    <q-td key="status" :props="props">
                        <q-btn :color="props.row.status == 'approve' ? 'positive' :'secondary'" outline  no-caps class="btn-one q-mr-md txt-capitalize" unelevated @click="openSidebarModal(props.row)">
                            {{props.row.status}}
                        </q-btn>
                        <!-- <q-img
                    ...
                    <div  style="padding: 0 15px;">
                        <div class="row">
                            ...
                            <div class="q-px-sm" :class="isInvoice ? 'col-6' : 'col-12'">
                                ...
                                <div class="row q-my-sm">
                                    <div class="col-12">
                                        <textarea name="" id="" cols="30" rows="2" placeholder="Masukan alasan ..." class="input-textarea fs-12" v-model="alasan"></textarea>
                                    </div>
                                </div>
                                <div class="row q-my-md">
    ...
    <upload-file v-model:upload="modalUpload" v-if="modalUpload" :typeFileUpload="'.pdf'" :menu="'claim'" @onUploadSuccess="callBackFuncFile"/>
</q-page>
</template>
<style>
...
export default {
    ...
    setup(){
        ...
        const { formatRibuan, openUpload, reload, modalUpload } = usePratesis()
        const klaim = [
