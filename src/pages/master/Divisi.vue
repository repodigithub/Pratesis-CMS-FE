...
<q-page>
      <Breadcrumb>
        <template v-slot:leftside>
            <q-breadcrumbs-el label="Divisi" style="color:#00000073;"  />
        </template>
    ...
    <UploadFile v-model:upload="modalUpload" v-if="modalUpload" menu="divisi"/>
</q-page>
</template>
...
const columns = [
  ...
  { name: 'region',  align: 'left',label: 'Divisi', field: 'nama_region', sortable: true },
]
export default {
    setup(){
