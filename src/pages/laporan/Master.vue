            ...
            <q-card flat>
                <q-card-section class="q-py-sm">
                    <div class="row justify-between items-center">
                        <p class="fs-18">Laporan Master</p>
                    </div>
                    <div class="row q-mx-none">
                        <div class="col-4 q-pr-md">
                            <div class="bg-auth q-pa-sm">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Master</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                                    <div class="col-12 q-mt-md">
                                        <select-dropdown url="area" v-model:selected="filter.area_id" :islogin="false" nameLabel="" class="bg-white" :placeHold="'AR-Area'"/>
                                    </div>
                                </div>
                            </div>
