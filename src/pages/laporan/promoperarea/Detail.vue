    ...
    <q-page>
        <breadcrumb  :rightside="false" :leftside="false">
            <template v-slot:breadcrumb-content>
                ...
                <q-breadcrumbs-el label="Detail Promo Per Area" style="color:#00000073;"/>
            </template>
        </breadcrumb>
        ...
        <div class="row q-pa-lg" v-else>
            ...
            <div class="col-12 q-mt-lg">
                <core-table
                    :columns="columns"
                    :url="`promo/${$route.params.id}/area`"
...
export default {
    ...
    setup(){
        ...
        const columns = [
            { name: 'nama_area',  align: 'left',label: 'Nama Area', field: 'nama_area'},
        ...
        router.push({name:'Detail Area',params:{id:route.params.id,area:value.id}})
        }
        return {
            active: true,
