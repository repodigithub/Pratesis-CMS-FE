            ...
            <div class="col-12">
                ...
                <q-card-section>
                    <div class="row items-end q-col-gutter-md">
                        ...
                        <div class="col">
                            <label for="statusDrop">Sort By :</label>
                                <q-select
                                    v-model="status_claim"
                                    :options="options"
                                    outlined
...
export default {
    ...
    setup(){
        ...
        const columns = [
            ...
            { name: 'tgl_kirim',  align: 'left',label: 'Total Opso ID', field: row => `${GeneralFormatDate(row.created_at,'DD/MM/YYYY')}`},
            { name: 'tgl_terima', label: 'Submit ', align: 'left', field:row => `${GeneralFormatDate(row.approved_date,'DD/MM/YYYY')}` },
            { name: 'tgl_terima', label: 'Approve ', align: 'left', field:row => `${GeneralFormatDate(row.approved_date,'DD/MM/YYYY')}` },
            { name: 'tgl_terima', label: 'Reject', align: 'left', field:row => `${GeneralFormatDate(row.approved_date,'DD/MM/YYYY')}` },
            { name: 'tgl_terima', label: 'Layak Bayar', align: 'left', field:row => `${GeneralFormatDate(row.approved_date,'DD/MM/YYYY')}` },
            { name: 'tgl_terima', label: 'Sudah Bayar', align: 'left', field:row => `${GeneralFormatDate(row.approved_date,'DD/MM/YYYY')}` },
        ]
