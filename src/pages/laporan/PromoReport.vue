                    ...
                    <div class="row q-mx-none">
                        <div class="col-4 q-pr-md">
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Promotion ID</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                                    <div class="col-5 q-mt-md">
                                        <q-input placeholder="ex. 3124" dense outlined class="bg-white">
                                            <template v-slot:append>
                                                <img  src="~assets/icon/docs_grey.svg" alt="">
                                            </template>
                                        </q-input>
                                    </div>
                                    ...
                                    <div class="col-5 q-mt-md">
                                        <q-input placeholder="ex. 3224" dense outlined class="bg-white">
                                            <template v-slot:append>
                                                <img  src="~assets/icon/docs_grey.svg" alt="">
                                            </template>
                                        </q-input>
                            ...
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Spend Type</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                            ...
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Status Promo</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                                    <div class="col-12 q-mt-md">
                                        <select-dropdown url="area" v-model:selected="filter.area_id" :islogin="false" nameLabel="" class="bg-white" :placeHold="'Select Status Promo'"/>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Product ID</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                            ...
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Product Level</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                                    <div class="col-12 q-mt-md">
                                        <select-dropdown url="area" v-model:selected="filter.area_id" :islogin="false" nameLabel="" class="bg-white" :placeHold="'Select Product Level'"/>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Customer number</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                            ...
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Customer Level</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                                    <div class="col-12 q-mt-md">
                                        <select-dropdown url="area" v-model:selected="filter.area_id" :islogin="false" nameLabel="" class="bg-white" :placeHold="'Select Customer Level'"/>
                                    </div>
                                </div>
                            </div>
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">Start Date</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
                            ...
                            <div class="bg-auth wrapper-init">
                                <div class="row">
                                    <div class="col-9">
                                        <span class="t-grey">End Date</span>
                                    </div>
                                    <div class="col-3 text-right">
                                        <img  src="~assets/icon/minus.svg" alt="">
                                    </div>
