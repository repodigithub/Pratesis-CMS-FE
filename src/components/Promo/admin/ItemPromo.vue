<template>
    <div class="row item-promo" @click="userAction">
        <q-checkbox v-if="$route.name == 'Approval'" v-model="cekpromo" label=" " />
        <q-img
                    ...
                    <core-table
                        ...
                        <template v-slot:toptable>
                            <div class="row justify-between">
                                ...
                                <div class="d">
                                    <router-link tag="span" :to="{name:'Detail Promo', params: {
                                        id: 3
                                    }}" class="text-primary">Lihat detail promo ></router-link>
                                </div>
                            </div>
                        </template>
