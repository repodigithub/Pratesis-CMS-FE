...
<breadcrumb  :rightside="false" :leftside="false">
    <template v-slot:breadcrumb-content>
        ...
        <q-breadcrumbs-el label="Edit Produk" style="color:#00000073;"/>
    </template>
</breadcrumb>
<div class="row justify-center" style="margin-top:65px;padding-bottom:40px;">
        <q-card class="col" style="max-width:818px;border-radius:10px !important;" flat>
            <q-card-section>
                <div class="font-big"> Edit Product </div>
            </q-card-section>
    ...
    setup () {
                        ...
                        altproducts.value.forEach(alt=>{
                            products.value.forEach(product=>{
                                if (alt.kode_produk === product.kode_produk) {
                                    ...
                                    product.budget = alt.budget_produk
        ...
        function onSubmit(){
            if (sisaBudget.value <= 10 && budgetbrand.value > 0) {
                showLoading()
                putData(`promo/${route.params.id}/product/${route.params.produk}`, {
        ...
        onMounted(()=>{
            ...
            .then(res=>{
                ...
                budgetbrand.value = result.budget_brand
